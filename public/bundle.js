...
Line.prototype.path = function() {
  ...
  if (this.d == 'bottom') return 'M0 0 '    + 'V' + p1       + ' L' + w      + ' ' + p2     + ' V0 z'
  if (this.d == 'left')   return 'M' + w + ' 0 H' + (w - p1) + ' L' + (w-p2) + ' ' + h      + ' H' + w + ' z'
  if (this.d == 'top')    return 'M0 ' + h + ' V' + (h-p1)   + ' L' + w      + ' ' + (h-p2) + ' V' + h + ' z'
  if (this.d == 'right')  return 'M0 0 '    + 'H' + p1       + ' L' + p2     + ' ' + h      + ' H0 z'
}
